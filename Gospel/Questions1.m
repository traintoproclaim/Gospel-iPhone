...
- (void)viewDidLoad
{
   ...
   self.view.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"background.png"]];
    ...
    _button5.adjustsImageWhenHighlighted = NO;
     ...
     [_button5 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
    
       

     name.delegate=self;
    _button1.frame = CGRectMake(0,80,190,21);
    _button2.frame = CGRectMake(0,140,190,21);
    _button3.frame = CGRectMake(0,200,190,21);
    _button4.frame = CGRectMake(180,80,190,21);
    _button5.frame = CGRectMake(180,140,190,21);
    
       
      
    CGRect lb1=CGRectMake(210, 0, 52, 30);
    CGRect lb2=CGRectMake(80, 30, 390, 30);
    CGRect lb3=CGRectMake(110, 80, 105, 22);
    CGRect lb4=CGRectMake(110, 140, 105, 22);
    CGRect lb5=CGRectMake(110, 200, 140, 22);
    CGRect lb6=CGRectMake(290, 80, 105, 22);
    CGRect lb7=CGRectMake(290, 140, 105, 22);
    CGRect lb8=CGRectMake(310, 200, 116, 38);
    CGRect lb9=CGRectMake(0, 270, 480, 50);
    
    quizlb.frame=lb1;
    quizlb.font= [UIFont fontWithName:@"Opificio" size:34.f];
    qlb.frame=lb2;
     qlb.font= [UIFont fontWithName:@"Opificio" size:19.f];
    qlb.textAlignment=UITextAlignmentLeft;
    flb.frame=lb3;
    flb.font= [UIFont fontWithName:@"Opificio" size:20.f];
    slb.frame=lb4;
    slb.font= [UIFont fontWithName:@"Opificio" size:20.f];
    tlb.frame=lb5;
    tlb.font= [UIFont fontWithName:@"Opificio" size:20.f];
    folb.frame=lb6;
    folb.font= [UIFont fontWithName:@"Opificio" size:20.f];
    filb.frame=lb7;
    filb.font= [UIFont fontWithName:@"Opificio" size:20.f];
    next.frame=lb8;
    
    
    quote.frame=lb9;
   
    quote.titleLabel.font= [UIFont fontWithName:@"Opificio" size:16.f];
...
-(IBAction)radiobuttoncheck5:(id)sender
{
    if(check5==NO)
    {
       [_button5 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateNormal];
        [_button2 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
        [_button3 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
        [_button4 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
        [_button1 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
