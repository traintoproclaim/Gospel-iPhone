...
- (void)viewDidLoad
{
    ...
    CGRect lb2=CGRectMake(50, 130, 350, 150);
    qlb.frame=lb2;
    head.frame=CGRectMake(170, 10, 200, 50);
     head.font= [UIFont fontWithName:@"Opificio" size:43.f];
     head.text=@"THE END";
    head.textColor=[UIColor blackColor];
    
    head1.frame=CGRectMake(100, 60, 300, 50);
    head1.font= [UIFont fontWithName:@"Opificio" size:36.f];
    head1.text=@"Have a great Day!";
    head.textColor=[UIColor blackColor];
    
    head2.frame=CGRectMake(50, 100, 350, 70);
    head2.font= [UIFont fontWithName:@"Opificio" size:20.f];
    ...
    qlb.font= [UIFont fontWithName:@"Opificio" size:20.f];

    qlb.textColor=[UIColor blackColor];
     next.frame=CGRectMake(340, 250, 60,27);
    login.hidden=YES;
    pwd.hidden=YES;
    login1.hidden=YES;
    pass.hidden=YES;
...
-(void)loadloginview
{
    login.frame=CGRectMake(150,40 , 190, 31);
    pwd.frame=CGRectMake(150, 90, 190, 31);
    ...
    login1.frame=CGRectMake(200, 150, 80, 35);
    UIImage *bk=[UIImage imageNamed:@"loginbtn.png"];
    ...
    pass.frame=CGRectMake(330, 240, 80, 35);
    UIImage *ps=[UIImage imageNamed:@"ragisterbtn.png"];
