...
- (void)viewDidLoad
{
    ...
    _button1.frame = CGRectMake(100,190,190,21);
    _button2.frame = CGRectMake(100,232,190,21);
    
       CGRect lb2=CGRectMake(10, -55, 462, 320);
    CGRect lb3=CGRectMake(210, 190, 105, 22);
    CGRect lb4=CGRectMake(210, 232, 105, 22);
    ...
    qlb.textColor=[UIColor blackColor];
     qlb.font= [UIFont fontWithName:@"Opificio" size:16.f];
    
    flb.text=@"I Agree";
    flb.font= [UIFont fontWithName:@"Opificio" size:18.f];

    flb.textColor=[UIColor blackColor];
    slb.textColor=[UIColor blackColor];
    slb.text=@"I Don’t agree";
    slb.font= [UIFont fontWithName:@"Opificio" size:18.f];
    ...
    email.frame=CGRectMake(150, 180, 180, 30);
    audiname.frame=CGRectMake(150, 140, 180, 30);
    ...
    send1.frame=CGRectMake(207, 230, 60,27);
    
    [send1 setImage:[UIImage imageNamed:@"send.png"] forState:UIControlStateNormal];
    [send1 setImage:[UIImage imageNamed:@"send.png"] forState:UIControlStateHighlighted];
    [send1 setImage:[UIImage imageNamed:@"send.png"] forState:UIControlStateSelected];
    ...
    CGRect lb1=CGRectMake(180, 20,160, 30);
    quizlb=[[UILabel alloc]init];
    quizlb.frame=lb1;
    quizlb.font= [UIFont fontWithName:@"Dominik" size:21.f];
...
-(void)dontagree
{
    ...
    qlb.text=@"To surrender to Jesus you must agree with this. I would like to send you a one off email that has a link to a free e-book that explains this some more. This will give you time to think about this decision and when you are ready it explains how you can surrender your life to Jesus.";
     CGRect lb2=CGRectMake(10, -95, 460, 350);
    qlb.frame=lb2;
    next.hidden=YES;
    flb.hidden=YES;
    slb.hidden=YES;
...
-(IBAction)nextview1:(id)sender
{
    NSUserDefaults *perf=[NSUserDefaults standardUserDefaults];
    [perf setObject:@"222" forKey:@"catch"];
    welldoneView *tab1=[[welldoneView alloc]initWithNibName:@"welldoneView" bundle:[NSBundle mainBundle]];            
