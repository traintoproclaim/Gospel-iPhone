...
- (void)viewDidLoad
{
    ...
    lable0.font= [UIFont fontWithName:@"Opificio" size:16.f];
    ...
    lable4.font= [UIFont fontWithName:@"Opificio" size:16.f];
    lable5.font= [UIFont fontWithName:@"Opificio" size:16.f];
    lable6.titleLabel.font= [UIFont fontWithName:@"Opificio" size:16.f];
     lable7.font= [UIFont fontWithName:@"Opificio" size:16.f];
    

    
    lable1.frame=CGRectMake(90, 10, 300, 46);
    lable1.textAlignment=UITextAlignmentCenter;
    
    lable0.frame=CGRectMake(0, 30, 480, 100);
    lable0.textAlignment=UITextAlignmentCenter;

    lable3.frame=CGRectMake(0, 100, 480, 100);
    lable3.textAlignment=UITextAlignmentCenter;
    
    lable2.frame=CGRectMake(20, 90,440, 40);
    lable2.textAlignment=UITextAlignmentCenter;
    
    lable7.frame=CGRectMake(10, 170, 180, 40);
    lable7.textAlignment=UITextAlignmentCenter;
    lable6.frame=CGRectMake(193, 176, 195, 30);
    lable6.titleLabel.textAlignment=UITextAlignmentCenter;
    lable4.frame=CGRectMake(383, 170, 80, 40);
    lable4.textAlignment=UITextAlignmentCenter;
    lable5.frame=CGRectMake(135, 180, 200, 100);
    ...
    lable5.numberOfLines=2;
     ...
     next.frame=CGRectMake(390, 270, 60,27);
...
-(IBAction)nextview:(id)sender
{
    ...
    donationView *tab1=[[donationView alloc]initWithNibName:@"donationView" bundle:[NSBundle mainBundle]];	
