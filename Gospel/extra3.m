...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"background.png"]];    lb2=CGRectMake(140, 30, 208, 193);
    
    lb5=CGRectMake(20, 20, 149, 137);
    image4=[[UIImageView alloc]initWithFrame:lb5];
    [image4 setImage:[UIImage imageNamed:@"speech_bubble_plead.png"]];
    [self.view addSubview:image4];
    
    lb7=CGRectMake(160,170, 154, 83);
    image6=[[UIImageView alloc]initWithFrame:lb7];
    image6.backgroundColor=[UIColor clearColor];
    [image6 setImage:[UIImage imageNamed:@"handcuffs.png"]];
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    switch (ex3)
    {
     case 1:
            lb1=CGRectMake(0, 270, 480, 50);
            lable1.frame=lb1;
            lb6=CGRectMake(180, 110, 99, 67);
            image5=[[UIImageView alloc]initWithFrame:lb6];
            [image5 setImage:[UIImage imageNamed:@"guilty.png"]];
        ...
        case 2: 
            [lable1 setTitle:@"But to everyones' horror the Judge says " forState:UIControlStateNormal];

            ex3=3;
            break;
        case 3:
            lb8=CGRectMake(290, 10, 174,147);
            image7=[[UIImageView alloc]initWithFrame:lb8];
            [image7 setImage:[UIImage imageNamed:@"speech_bubble_judge.png"]];
        ...
        case 4:image4.hidden=YES;
            ...
            image6.hidden=YES;
            image7.hidden=YES;
            lb13=CGRectMake(180, 30, 127,163);
            image8=[[UIImageView alloc]initWithFrame:lb13];
            [image8 setImage:[UIImage imageNamed:@"fist.png"]];
            [self.view addSubview:image8];
            
            lb13=CGRectMake(150, 200, 200, 30);
            lable5=[[UILabel alloc]initWithFrame:lb13];
            lable5.text=@"WOULD THAT SOUND";
            lable5.font= [UIFont fontWithName:@"Opificio" size:19.f];
            ...
            lb10=CGRectMake(225, 220, 150, 30);
