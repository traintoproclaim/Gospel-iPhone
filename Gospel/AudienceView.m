...
- (void)viewDidLoad
{
  ...
  self.view.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"background.png"]];
   ...
   _button1.frame = CGRectMake(62,100,160,21);
    _button2.frame = CGRectMake(62,140,160,21);
    _button3.frame = CGRectMake(62,180,160,21);
    ...
    CGRect lb5=CGRectMake(160, 100, 105, 22);
    CGRect lb6=CGRectMake(160, 140, 105, 22);
    CGRect lb7=CGRectMake(160, 180, 105, 22);
    CGRect lb8=CGRectMake(325, 260, 116, 38);
     CGRect bt1=CGRectMake(212, 41, 122 , 31);
    CGRect nlb=CGRectMake(50, 40, 158, 40);
    
    lb1.frame=lb5;
    lb1.font= [UIFont fontWithName:@"Opificio" size:22.f];
    lb2.frame=lb6;
    lb2.font= [UIFont fontWithName:@"Opificio" size:22.f];
    lb3.frame=lb7;
    lb3.font= [UIFont fontWithName:@"Opificio" size:22.f];
    next.frame=lb8;
    name.frame=bt1;
    inst.frame=nlb;
    inst.font= [UIFont fontWithName:@"Opificio" size:25.f];
