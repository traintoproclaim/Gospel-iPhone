...
- (void)viewDidLoad
{
    ...
    day.frame=CGRectMake(51, 65, 120, 40);
    day.text=@"On this day :";
    day.font= [UIFont fontWithName:@"Opificio" size:17.f];
    day.textColor=[UIColor blackColor];
    day.backgroundColor=[UIColor clearColor];
    [self.view addSubview:day];
    
    country=[[UILabel alloc]init];
    country.frame=CGRectMake(240, 95, 180, 40);
    country.text=@"Country of Origin:";
    country.font= [UIFont fontWithName:@"Opificio" size:16.f];
    ...
    numbers.frame=CGRectMake(52, 95, 180, 40);
    numbers.text=@"Number Reached:";
    numbers.font= [UIFont fontWithName:@"Opificio" size:16.f];
    ...
    qlb.frame=CGRectMake(50, 20, 240, 35);
    qlb.textAlignment=UITextAlignmentLeft;
    qlb.numberOfLines=2;
    qlb.font= [UIFont fontWithName:@"Opificio" size:17.f];
    ...
    loginchange.frame=CGRectMake(42, 47, 130, 30);
    loginchange.titleLabel.font= [UIFont fontWithName:@"Opificio" size:17.f];
    
      datebtn.frame=CGRectMake(160, 68, 100, 30);
    ...
    list.frame=CGRectMake(200, 130, 200, 41);
    
    UIImage *lg11=[UIImage imageNamed:@"counrtybtn.png"];
    ...
    list.titleLabel.font= [UIFont fontWithName:@"Opificio" size:15.f];
    ...
    list1.frame=CGRectMake(200, 185, 200, 41);
    UIImage *lg12=[UIImage imageNamed:@"counrtybtn.png"];
    if(loginstr1.length!=0&&loginstr1!=nil)
    {
    ...
    list1.titleLabel.font= [UIFont fontWithName:@"Opificio" size:15.f];
    ...
    list2.frame=CGRectMake(200, 240, 200, 41);
    UIImage *lg13=[UIImage imageNamed:@"counrtybtn.png"];
    if(loginstr1.length!=0&&loginstr1!=nil)
    {
   ...
   [list2 setBackgroundImage:lg13 forState:UIControlStateNormal];
    ...
    list2.titleLabel.font= [UIFont fontWithName:@"Opificio" size:15.f];
    ...
    [self.view addSubview:list2];
     ...
     no1.frame=CGRectMake(60, 130, 100, 41);
     UIImage *lg=[UIImage imageNamed:@"numberbtn.png"];
     ...
     no1.titleLabel.font= [UIFont fontWithName:@"Opificio" size:15.f];
     ...
     no2.frame=CGRectMake(60, 185, 100, 41);
     UIImage *lg1=[UIImage imageNamed:@"numberbtn.png"];
     ...
     no2.titleLabel.font= [UIFont fontWithName:@"Opificio" size:15.f];
    ...
    no3.frame=CGRectMake(60, 240, 100, 41);
    UIImage *lg3=[UIImage imageNamed:@"numberbtn.png"];
    ...
    no3.titleLabel.font= [UIFont fontWithName:@"Opificio" size:15.f];
    ...
    send.frame=CGRectMake(410, 270, 60,27);
    [send setImage:[UIImage imageNamed:@"send.png"] forState:UIControlStateNormal];
    [send setImage:[UIImage imageNamed:@"send.png"] forState:UIControlStateHighlighted];
    [send setImage:[UIImage imageNamed:@"send.png"] forState:UIControlStateSelected];
...
-(void)showDatePicker
{
    ...
    [button setBackgroundImage:[UIImage imageNamed:@"done.png"] forState:UIControlStateNormal];
...
{
    welldoneView *backview=[[welldoneView alloc]initWithNibName:@"welldoneView" bundle:nil];
...
-(IBAction)addlistonmenu:(id)sender
{
    ...
    customView.frame=CGRectMake(0, 90, 480, 220);
    customView.backgroundColor=[UIColor grayColor];
    self.tableview.rowHeight = 40;
    tableview.frame=CGRectMake(0, 0, 480,220);
...
-(IBAction)addlistonmenu1:(id)sender
{
    ...
    customView.frame=CGRectMake(0, 90, 480, 240);
    customView.backgroundColor=[UIColor grayColor];
...
-(IBAction)addnumberonmenu:(id)sender
{
    ...
    self.tableview1.rowHeight = 40;
    tableview1.frame=CGRectMake(0, 0, 480, 210);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
	...
	cell.textLabel.font =[UIFont fontWithName:@"Opificio" size:12.f];
    }else
    {
