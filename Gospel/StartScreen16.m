...
- (void)viewDidLoad
{
    ...
    lable1.frame=CGRectMake(0,20, 480, 100);
    lable1.text=@"Which statement best describes your response to this presentation?";
    lable1.font= [UIFont fontWithName:@"Opificio" size:17.f];
    ...
    lable6.frame=CGRectMake(10, 10, 460, 190);
    lable6.font= [UIFont fontWithName:@"Opificio" size:17.f];
    ...
    [_button3 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
    [_button4 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
 
    [_button1 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateHighlighted];
    [_button1 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateSelected]; 
    [_button2 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateHighlighted];
    [_button2 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateSelected]; 

    [_button3 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateHighlighted];
    [_button3 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateSelected]; 
    [_button4 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateHighlighted];
    [_button4 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateSelected]; 


    
  
    _button1.frame = CGRectMake(-20,111,300,21);
    _button2.frame = CGRectMake(-20,151,300,21);
    _button3.frame = CGRectMake(-20,191,300,21);
    _button4.frame = CGRectMake(-20,231,300,21);
    
    lable2=[[UILabel alloc]init];
    lable2.frame=CGRectMake(160, 100, 250, 40);
    lable2.text=@"I don’t believe it";
    lable2.font= [UIFont fontWithName:@"Opificio" size:17.f];
    ...
    lable3.frame=CGRectMake(160, 140, 250, 40);
    ...
    lable4.frame=CGRectMake(160, 180, 250, 40);
    lable4.text=@"I’d like to explore it further";
    lable4.font= [UIFont fontWithName:@"Opificio" size:17.f];
    ...
    lable5.frame=CGRectMake(160, 220, 320, 40);
    lable5.text=@"I want to surrender to Jesus right now";
    lable5.font= [UIFont fontWithName:@"Opificio" size:17.f];
    ...
    send1.frame = CGRectMake(205, 200, 60,27);
    [send1 setImage:[UIImage imageNamed:@"end_1.png"] forState:UIControlStateNormal];
    ...
    send2.frame = CGRectMake(207, 240, 60,27);
    [send2 setImage:[UIImage imageNamed:@"send.png"] forState:UIControlStateNormal];
    ...
    send3.frame = CGRectMake(207, 240, 60,27);
    [send3 setImage:[UIImage imageNamed:@"send.png"] forState:UIControlStateNormal];
    ...
    send4.frame = CGRectMake(380, 250, 60,27);
    [send4 setImage:[UIImage imageNamed:@"end_1.png"] forState:UIControlStateNormal];
    ...
    email.frame=CGRectMake(150,200, 180, 30);
     audiname.frame=CGRectMake(150, 160, 180, 30);
    ...
    email.hidden=YES;
    CGRect lb1=CGRectMake(180, 10,160, 30);
    quizlb=[[UILabel alloc]init];
    quizlb.frame=lb1;
    quizlb.font= [UIFont fontWithName:@"Opificio" size:21.f];
    ...
    next1.frame = CGRectMake(380, 250, 60,27);
    next1.hidden=YES;
...
- (void)dismissHUD:(id)arg {
    ...
    [alert show];
    [alert release];
    welldoneView *ta=[[welldoneView alloc]initWithNibName:@"welldoneView" bundle:[NSBundle mainBundle]];            
...
-(IBAction)radiobuttoncheck1:(id)sender
{
    if(check1==NO)
    {
        ...
        clickbutton1=1;
        clickButton=1;
        next1.frame=CGRectMake(380, 250, 66,27);
        [next1 setImage:[UIImage imageNamed:@"end_11.png"] forState:UIControlStateNormal];
        next1.hidden=NO;
        [self hideradio];
        quizlb.hidden=NO;
...
-(IBAction)radiobuttoncheck3:(id)sender
{
    ...
    { NSUserDefaults *bc1=[NSUserDefaults standardUserDefaults];
        ...
        [_button3 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateNormal];
        [_button2 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
        [_button1 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
        [_button4 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
...
-(IBAction)radiobuttoncheck4:(id)sender
{
    if(check4==NO)
    {
        ...
        [_button4 setImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateNormal];
        [_button2 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
        [_button3 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
        [_button1 setImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
        ...
        quizlb.hidden=NO;
        send4.hidden=NO;
        [send4 setImage:[UIImage imageNamed:@"next_1.png"] forState:UIControlStateNormal];
...
-(IBAction)send2Action:(id)sender
{
    ...
    NSLog(@"Remain count %d",count);
     GospelAppDelegate *appDelegate = (GospelAppDelegate*)[[UIApplication sharedApplication] delegate];
    [self hideradio];
