...
- (void)viewDidLoad
{
    ...
    lb11=CGRectMake(70, 230,335,20);
    image10=[[UIImageView alloc]initWithFrame:lb11];
    [image10 setImage:[UIImage imageNamed:@"3-major-events.png"]];
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    switch (ex6)
    {
        case 1:
            ...
            [image11 setImage:[UIImage imageNamed:@"event_birth.png"]];
            ...
            ex6=2;
            break;
        case 2:[image11 setImage:[UIImage imageNamed:@"event_death.png"]];
