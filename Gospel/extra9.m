...
- (void)viewDidLoad
{
    ...
    lb6=CGRectMake(150, 110,193,38);
    image4=[[UIImageView alloc]initWithFrame:lb6];
    [image4 setImage:[UIImage imageNamed:@"heaven_large.png"]];
...
{
    image6=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"close12.png"]];
    lb9=CGRectMake(165, 30, 150, 203);
    image6.frame=lb9;
    image6.animationImages =[NSArray arrayWithObjects:
                             ...
                             [UIImage imageNamed:@"close12.png"],
                             nil];
