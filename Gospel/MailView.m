...
- (void)viewDidLoad
{
  ...
  self.view.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageNamed:@"background.png"]];
    ...
    lable1.frame=CGRectMake(10, 10, 480, 150);
    ...
    lable1.font= [UIFont fontWithName:@"Opificio" size:16.f];
...
- (void)dismissHUD:(id)arg {
    ...
    tab1=[[welldoneView alloc]initWithNibName:@"welldoneView" bundle:[NSBundle mainBundle]];            
