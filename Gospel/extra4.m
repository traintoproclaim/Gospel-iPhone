...
- (void)viewDidLoad
{
    ...
    lb6=CGRectMake(0, 0, 470, 320);
    image5=[[UIImageView alloc]initWithFrame:lb6];
    [image5 setImage:[UIImage imageNamed:@"page-no-24.png"]];
    ...
    switch (ex4)
    {
      case 1:[self callsmallcircleimages];
        ...
        case 2:[self callsmallcircleimages1];
            ...
            break;
       case 3:
            lb10=CGRectMake(260, 230, 138,21);
            image9=[[UIImageView alloc]initWithFrame:lb10];
            [image9 setImage:[UIImage imageNamed:@"Imperfect_1.png"]];
        ...
        case 5:lb9=CGRectMake(55, 230, 118, 21);
            image8=[[UIImageView alloc]initWithFrame:lb9];
            [image8 setImage:[UIImage imageNamed:@"Perfect_1.png"]];
...
{
    image6=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Small-Circle5.png"]];
    lb2=CGRectMake(75,100,71,114);
    image6.frame=lb2;
    image6.animationImages =[NSArray arrayWithObjects:
                             [UIImage imageNamed:@"Small-Circle1.png"],
                             [UIImage imageNamed:@"Small-Circle2.png"],
                             [UIImage imageNamed:@"Small-Circle3.png"],
                             [UIImage imageNamed:@"Small-Circle4.png"],
                             [UIImage imageNamed:@"Small-Circle5.png"],nil];
...
{
    image7=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"Small-Circle5.png"]];
    lb3=CGRectMake(293, 100, 71,114);
    image7.frame=lb3;
